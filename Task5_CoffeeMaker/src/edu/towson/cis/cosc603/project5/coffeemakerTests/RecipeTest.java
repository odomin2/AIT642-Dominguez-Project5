...
public class RecipeTest {
	/**
	 * Run the boolean addRecipe(CoffeeMaker) method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 4/26/16 6:28 PM
	...
	public void testAddRecipe_1()
		...
		//coffeeMaker.setRecipeArray(new Recipe[] {new Recipe()});

		boolean result = fixture.addRecipe(coffeeMaker);
		assertNotEquals(false, result);
		// add additional test code here
		// An unexpected exception was thrown in user code while executing this test:
		//    java.lang.ArrayIndexOutOfBoundsException: 1
		//       at edu.towson.cis.cosc603.project5.coffeemaker.Recipe.addRecipe(Recipe.java:162)
		//assertTrue(result);
	}
